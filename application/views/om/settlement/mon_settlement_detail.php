...
<div class="container">
    <form method="post" enctype="multipart/form-data" id="main_form" class="form-horizontal">
        ...
        <section class="content-header" style="max-width:1800px; margin-right:auto; margin-left:auto;">
            <h1>
                Monitoring Settlement Cetak </h1>
        </section>
                            ...
                            <tbody>
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <td></td>
                                        <td style="vertical-align:top;width:200px" nowrap><?php echo $this->Global_model->uraian_settlement($key, 1, 2, $arrPeriode); ?> <a href="#" onClick="openModal2('<?php echo base_url('panelbackend/mon_settlement/history/' . $key . '/1') ?>')">read more</a></td>
                                        <td style="vertical-align:top;width:200px" nowrap><?php echo $this->Global_model->uraian_settlement($key, 2, 2, $arrPeriode); ?> <a href="#" onClick="openModal2('<?php echo base_url('panelbackend/mon_settlement/history/' . $key . '/2') ?>')">read more</a></td>
                                ...
                                <tr>
                                    ...
                                    <td></td>
                                    <td style="vertical-align:top;width:200px" nowrap><?php //echo $this->Global_model->uraian_settlement($key, 1); 
                                                                                        ?></td>
                                    <td style="vertical-align:top;width:200px" nowrap><?php //echo $this->Global_model->uraian_settlement($key, 2); 
                                                                                        ?></td>
