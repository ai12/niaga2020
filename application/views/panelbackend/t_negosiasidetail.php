<div class="col-sm-6">
	...
	?>
	<?php
	$from = UI::createUpload("file", $row['file'], "panelbackend/t_negosiasi", $edited, "file");
...
<div class="row">
	<div class="col-sm-12">
		<?php $this->load->view('om/template/_approval', ['id' => $row['ref_id'], 'edited' => $edited, 'status' => $this->Global_model->STATUS_NEGOSIASI,'log_trans'=>'HIS_NEGOSIASI','log_id'=>$row['id_nego']]); ?>
	</div>
</div>