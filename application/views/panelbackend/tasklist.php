  ...
  <table class="table table-striped table-hover dataTable">
    ...
    foreach($list['rows'] as $rows){
        ...
        $add = array(
            '<li><a href="'.site_url('panelbackend/task/edit/'.$rows['id_task'].'/1').'" class="waves-effect"><span class="glyphicon glyphicon-share"></span> Follow Up</a> </li>'
        );
        echo UI::showMenuMode('inlist', $rows[$pk],false,'','',null,null,$add);
    	echo "</td>";
    	echo "</tr>";
    }
    if(!count($list['rows'])){
