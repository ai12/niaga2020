  ...
  <table class="table table-striped table-hover dataTable">
    ...
    <tbody>
        <!-- panelbackend/t_simrab_jasa_material/index/ -->
    <?php
    $i = $page;
    	...
    	foreach($header as $rows1){
            ...
            if($rows1['name']=='nama_pekerjaan'){
                if($add_param)
                    ...
                    echo "<td><a href='".($url=base_url("panelbackend/t_simrab_jasa_material/index/$rows[$pk]"))."'>$val</a></td>";   
            }elseif($rows1['name']=='isi'){
                echo "<td>".ReadMore($val,$url)."</td>";
            }elseif($rows1['name']=='hpp'||$rows1['name']=='proposal_penawaran'||$rows1['name']=='standar_produksi'){
