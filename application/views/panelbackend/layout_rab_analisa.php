  ...
  <div class="box box-default">
      <div class="tab-content">
        <div class="tab-pane active" id="tab_1">
          ...
          <div class="box-body">
            <?php if($ctrl=="rab_e_detail" and $mode=='index' && !$rows){ ?>
              <button type="button" class="btn btn-warning" onclick="goSubmit('generate_rab')">Generate RAB Evaluasi</button>
            <?php }else{ ?>
              <?=$this->auth->GetTabRabEvaluasi($rowheader['id_proyek'], $rowheader1['id_proyek_pekerjaan'], $id_rab, $rowheader2['is_final']);?>
