...
<?php 
if($row['sumber_nilai']<>'6' && $row['sumber_nilai']<>'7' && $row['sumber_nilai']<>'8'){
...
if($edited or count($row['files'])){
$from = UI::createUploadMultiple("files", $row['files'], $page_ctrl, $edited, "files");
echo UI::createFormGroup($from, $rules["files"], "files", "Lampiran", false, 3);
}
