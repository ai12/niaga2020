<div class="col-sm-6">
	...
	?>
	<?php
	$from = UI::createTextBox('gpm', $row['gpm'], '3', '3', $edited, 'form-control rupiah', "style='text-align:right; width:80px' min='0' max='100' step='1'");
	echo UI::createFormGroup($from, $rules["gpm"], "gpm", "GPM (%)");
	?>
	<?php
	$from = UI::createTextBox('npm', $row['npm'], '3', '3', $edited, 'form-control rupiah', "style='text-align:right; width:80px' min='0' step='1'");
...
<div class="row">
<div class="col-sm-12">
			<?php $this->load->view('om/template/_approval', ['id' => $row['ref_id'], 'edited' => $edited, 'status'=>$this->Global_model->STATUS_PROPOSAL,'log_trans'=>'HIS_PROPOSAL','log_id'=>$row['id_proposal']]); ?>
		</div>
</div>