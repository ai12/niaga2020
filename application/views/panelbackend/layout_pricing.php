  ...
  <div class="box box-default">
      <div class="tab-content">
        <div class="tab-pane active" id="tab_1">
          ...
          <div class="box-body">
            <?php if($ctrl=="rab_penawaran" and $mode=='index' && !$rows){ if(!$rowheader['id_wilayah_proyek']){ ?>
              <div class="alert alert-danger">Informasi wilayah proyek dan zona sppd belum di <a href="<?=site_url("panelbackend/proyek/edit/$rowheader[id_proyek]")?>">isi</a></div>
            <?php }else{ ?>
              <button type="button" class="btn btn-warning" onclick="goSubmit('generate_penawaran')">Generate Pricing</button>
            <?php }}else{ ?>
              <?=$this->auth->GetTabPricing($rowheader['id_proyek'], $rowheader1['id_proyek_pekerjaan'], $id_rab, $rowheader2['is_final']);?>
