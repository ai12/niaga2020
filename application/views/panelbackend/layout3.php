...
<center>
	<div class="notshow">
	<?php if($excel!==false){ ?>
	<a download="<?=$page_title?>.xls" class="btn btn-sm btn-primary" href="#" onclick="return ExcellentExport.excel(this, 'datatable', '<?=rawurlencode($page_title)?>');">
...
<div id="datatable">
	...
	<ins><h4 style="padding:10px;text-align: center; line-height: 24px;">
	<b><?=$page_title?></b>
	</h4></ins>
	<?php } ?>
<?php echo $content1;?>
...
.table thead tr th, .table thead tr th div{
	color: #fff !important;
}
</style>
