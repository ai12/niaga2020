		...
		class T_wo_prospek extends _omController
		{
			...
			public function __construct()
			{
				...
				$_SESSION['menu_id'] = 1092;
				$this->modul = 't_wo_prospek';
				$this->load->model('om/t_wo_prospek_model', 'mod');
				...
				$this->niagaarr = $this->niagamodel->GetCombo(" where ID_JENIS_OPPORTUNITIES = 2 ");
				unset($this->niagaarr['']);
