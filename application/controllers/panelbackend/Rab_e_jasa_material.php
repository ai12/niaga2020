...
class Rab_e_jasa_material extends _adminController{
	...
	protected function init(){
		parent::init();
		$this->viewlist = "panelbackend/rab_e_jasa_materiallist";
		$this->viewdetail = "panelbackend/rab_e_jasa_materialdetail";
		...
		$this->load->model("Rab_e_jasa_materialModel","model");
...
/*		if($this->data['row']['jasa_material']=='1'){
	...
	public function go_print($id_rab=0, $page=0){
		...
		$this->_setFilter("a.id_rab_evaluasi = ".$this->conn->escape($this->id_rab_evaluasi));
