<?php class KeluhanModel extends _Model{
	public $table = "keluhan";
	public $pk = "id_keluhan";
	public $label = "nama";
	...
	public function SelectGrid($arr_param=array(), $str_field="*")
	{
		...
		$table = "(select a.*, b.nama_proyek, c.nama as nama_customer
		from keluhan a 
		left join proyek b on a.id_proyek = b.id_proyek
		left join customer c on b.id_customer = c.id_customer) a";
