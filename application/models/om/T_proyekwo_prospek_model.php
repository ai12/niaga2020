...
class T_proyekwo_prospek_model extends _omModel
{
	...
	var $pk 	= 'id_wo';
	var $column = [
		'kode_wo' => 'Work Order', 'deskripsi' => 'WO Description', 'id_customer' => 'Customer', 'nama' => 'Nama',
		'jenis' => 'Jenis', 'jenis_rkap' => 'Jenis RKAP', 'jenis_niaga' => 'Jenis niaga',
		'tanggal' => 'Tanggal', 'nilai' => 'Estimasi Nilai Pekerjaan', 'pic_id' => 'PIC', /*'user_status' => 'Status',*/
	];
